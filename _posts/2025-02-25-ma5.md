...
![image](https://github.com/user-attachments/assets/d1affbe8-dd2d-4bbb-a5ad-6602264a0f12)

[그림 1. Detect it easy 결과]

● PECompact로 패킹된 악성코드의 특징은 88 50 64 33C0 8908로 시작하는 것을 볼 수 있다.

![image](https://github.com/user-attachments/assets/0df6ba66-f4b7-4b1a-a92c-8e55bc471965)
...
![image](https://github.com/user-attachments/assets/147be5c4-3ab8-4541-baf5-d998329f7c06)

[그림 3. esp에 저장된 주소 따라감]

![image](https://github.com/user-attachments/assets/aaae7c24-f088-4deb-b532-b134cee2d90d)

[그림 4. 하드웨어 브레이크 포인트 지점]

● 브레이크 포인트 설정 후 계속 실행하다 보면 보통의 패커들과 동일하게 언패킹된 곳으로 이동하는 jmp 지점을 찾을 수 있다.

![image](https://github.com/user-attachments/assets/49796298-2485-4e01-b92f-6aa4a41d0b22)

[그림 5. jmp 지점 확인]

● F7을 통해 jmp 지점으로 이동한 뒤 x32dbg에 내장되어있는 Scylla를 실행하고 순서대로 진행하면 아래와같이 SCY 파일이 생성된 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/100b4579-a178-44e2-b33c-fd8d5e3966a7)

[그림 6. Scylla 실행 순서]

![image](https://github.com/user-attachments/assets/85347831-458e-4c15-abef-b76d28d29a1f)

[그림 7. SCY 파일 생성 확인]

● 언패킹이 완료되었으므로 분석을 진행 해보면 매우 많은 함수들이 존재하며 Start에서 시작하는 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/d0eab530-b830-4d01-bb6f-b4aea314afba)

[그림 8. 파일 시작 부분 확인]

● sub_40968C -> sub_401079 -> sub_40108F로 진입하면 여러 함수들을 확인할 수 있는데 핵심적인 함수들은 아래와 같다.

![image](https://github.com/user-attachments/assets/5e33bba1-fdf5-431a-894f-6dd0d3c3add6)

[그림 9. sub_40108F]

● sub_401966을 살펴보면, 아래와 같이 현재 실행 중인 악성 코드의 경로를 가져오는 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/b35d9d24-5fdd-40ca-ac74-5baa7013fb0e)

[그림 10. 악성 코드 파일 경로 추출 함수 확인]

![image](https://github.com/user-attachments/assets/da8e6736-d771-453a-8321-f3cc388680e1)

[그림 11. 추출된 악성 코드 경로 확인]

● 계속 진행해 보면, 아래와 같이 CommonFiles 환경 변수 경로를 추출하는 것도 확인할 수 있으며, 현재 실행 중인 악성 코드의 파일명도 추출하는 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/21525d99-ed70-4aa9-ae7a-37a6e9e719ec)

[그림 12. CommonFiles 환경 변수 경로 추출 함수 확인]

![image](https://github.com/user-attachments/assets/974702fd-74e3-4e9b-aec9-e688fd9a66f1)

[그림 13. 추출된 환경 변수 경로 확인]

![image](https://github.com/user-attachments/assets/634a694e-8403-4dc6-bf79-13ad73e78707)

[그림 14. 파밀명 추출 함수 확인]

![image](https://github.com/user-attachments/assets/5b60bd21-892e-4c37-9f85-35d703e4bac9)

[그림 15. 추출된 파일명 확인]

● 이 후, 환경 변수와 파일명을 합친 후 반환하는 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/fe1b03ed-f18c-4003-989c-8b7a12e8a6ea)

[그림 16. 여러 문자열을 하나의 버퍼에 합치는 함수 확인]

![image](https://github.com/user-attachments/assets/ae4b39cd-64e3-48b4-918a-a4f9c3f8ca89)

[그림 17. 반환 문자열 확인]

● 그 다음, koreaautoup.bmp라는 파일명을 추출한 뒤 생성하는 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/3f6f7031-f67c-4e37-b948-94696e4e81c8)

[그림 18. koreaautoup.bmp 파일명 추출 함수]

![image](https://github.com/user-attachments/assets/93187131-af39-4ed8-8332-087434e8f88d)

[그림 19. koreaautoup.bmp 파일명 확인]

![image](https://github.com/user-attachments/assets/546a7904-a3b5-4b34-a203-c5c1bc641784)

[그림 20. 파일생성 함수]

![image](https://github.com/user-attachments/assets/cc9d3bc7-5697-46d7-a26a-969e5bde5e3e)
...
![image](https://github.com/user-attachments/assets/71e3df63-07b9-4ccc-85d3-31336aa3e792)

[그림 22. 레지스트리 문자열 반환 1]

![image](https://github.com/user-attachments/assets/b1d6f04b-e3a5-45be-9925-7f93d51cf5c1)

[그림 23. 반환된 레지스트리 문자열 1]

![image](https://github.com/user-attachments/assets/88bb53e0-512b-4ddc-aee1-140cbc74eb69)

[그림 24. 레지스트리 생성 함수]

![image](https://github.com/user-attachments/assets/1f5dc450-ce39-460c-b117-21a220f874e5)

[그림 25. 레지스트리 키 생성 함수]

![image](https://github.com/user-attachments/assets/53edb218-448a-43cf-b473-b1683525c553)

[그림 25. 입력값에 따른 레지스트리 키 반환]

● 이 후, 원본 악성 코드를 Common Files, Temp 디렉토리에 복사 후 원본 파일을 제거하는 것을 확인할 수 있다.

![image](https://github.com/user-attachments/assets/7235574d-0925-46c7-aa89-3902e41324b1)

[그림 26. Common Files에 파일을 복사하는 함수]

![image](https://github.com/user-attachments/assets/cd81554f-c8ff-4de7-b1b4-7db6fa9fb589)

[그림 27. 파일 복사 확인]

![image](https://github.com/user-attachments/assets/7a178547-c5e9-480c-8e5b-4471b0990885)

[그림 28. TemporaryFile 디렉토리 생성 및 원본 파일 복사, 제거 함수]

![image](https://github.com/user-attachments/assets/53896641-ae75-410e-9cf7-c85fa5244631)

[그림 29. TemporaryFile 형태의 복사된 파일 확인]

● 이후로는 쭉 레지스트리 값을 추출하여 생성하는 것을 반복 한다. (레지스트리 생성 함수의 경우 위와 동일 sub_40A370)

![image](https://github.com/user-attachments/assets/8fa914e4-4eb7-4257-8b1b-2e8b06005f15)

[그림 30. 레지스트리 문자열 반환 2]

![image](https://github.com/user-attachments/assets/b9a0b455-367a-4b99-adc2-9cc2aecdea39)

[그림 31. 반환된 레지스트리 문자열 2]

![image](https://github.com/user-attachments/assets/f99243a9-4ee5-4e0b-bd53-47cbccaa51fc)

[그림 32. 레지스트리 문자열 반환 3]

![image](https://github.com/user-attachments/assets/6c42ba9a-cce0-4d9c-921d-e8f9ef2decbd)

[그림 33. 반환된 레지스트리 문자열 3]

![image](https://github.com/user-attachments/assets/c00b561c-bb0f-469c-8c60-dee83e99c951)

[그림 34. 레지스트리 문자열 반환 4]

![image](https://github.com/user-attachments/assets/11bec981-cdf6-4a8b-8222-828ca70bedcc)

[그림 35. 반환된 레지스트리 문자열 4]

![image](https://github.com/user-attachments/assets/97fc2214-9c5a-4324-a3c3-b4a87090d27a)
